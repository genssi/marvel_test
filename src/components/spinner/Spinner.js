const Spinner = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" style={{ margin: '0 auto', background: 'none', display: 'block' }} width="200" height="200">
            <g>
